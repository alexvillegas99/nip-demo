...
@Component({
  selector: 'app-pantalla-medidores',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule, RouterModule],
  templateUrl: './pantalla-medidores.component.html',
  styleUrl: './pantalla-medidores.component.scss',
})
export class PantallaMedidoresComponent {
  menu: any = [
    {
      nombre: 'MEDIDOR DE ENERGÍA',
      path: 'medidor',
      isSelected: false,
 ...
 */
  ...
  mantenimientos = [
    ...
    },
    {
      ...
      funcion:
        'Reducir la fricción y el desgaste, aumentando la vida útil del compresor',
      detallesAdicionales: {
        descripcion:
          'La lubricación de los rodamientos es esencial para reducir la fricción y el desgaste de los componentes móviles del compresor, como los rotores y ejes. Esto ayuda a prolongar la vida útil del compresor y mantener su eficiencia operativa. Es importante utilizar el lubricante adecuado y seguir las recomendaciones del fabricante para el mantenimiento periódico.',
        pasos: [
    ...
    },
    {
      ...
      detallesAdicionales: {
        descripcion:
          'La revisión de las conexiones eléctricas del compresor es esencial para garantizar su correcto funcionamiento y seguridad. Las conexiones deben estar firmemente ajustadas y libres de corrosión o daños. Se debe prestar especial atención a los puntos de conexión de alta corriente para evitar sobrecalentamientos y cortocircuitos.',
        pasos: [
    ...
    },
    {
      ...
      funcion:
        'Detectar y prevenir fugas de aire que puedan afectar el rendimiento del compresor',
      detallesAdicionales: {
        descripcion:
          'La inspección regular de las mangueras y conductos de aire es esencial para mantener la integridad del sistema de aire del compresor. Las fugas de aire pueden reducir la eficiencia del compresor y provocar un rendimiento deficiente. Es importante revisar todas las mangueras y conductos en busca de grietas, abolladuras o conexiones sueltas, y reparar o reemplazar cualquier componente dañado.',
        pasos: [
    ...
    },
    {
      ...
      funcion:
        'Eliminar acumulaciones de suciedad que puedan reducir la eficiencia del enfriamiento',
      detallesAdicionales: {
        descripcion:
          'La limpieza periódica del serpentín de enfriamiento es esencial para mantener la eficiencia del sistema de refrigeración del compresor. Con el tiempo, el serpentín puede acumular suciedad, polvo y otros contaminantes que obstruyen el flujo de aire y reducen la capacidad de enfriamiento. Es importante limpiar el serpentín regularmente para garantizar un rendimiento óptimo del compresor.',
        pasos: [
    ...
    },
    {
      ...
      funcion:
        'Garantizar la seguridad operativa al proteger el compresor de sobrepresiones',
      detallesAdicionales: {
        descripcion:
    ...
    },
    {
      ...
      funcion:
        'Asegurar mediciones precisas para un funcionamiento óptimo del compresor',
      detallesAdicionales: {
        descripcion:
          'La calibración regular de los sensores de temperatura y presión es esencial para garantizar mediciones precisas y un funcionamiento óptimo del compresor. Los sensores descalibrados pueden conducir a lecturas incorrectas y a un rendimiento inadecuado del compresor. Es importante seguir las instrucciones del fabricante y utilizar equipos de calibración adecuados para realizar la calibración de manera precisa y confiable.',
        pasos: [
    ...
    },
    {
      ...
      funcion:
        'Mantener niveles adecuados de refrigerante para un funcionamiento eficiente',
      detallesAdicionales: {
        descripcion:
          'La verificación regular del nivel de refrigerante es esencial para garantizar un funcionamiento eficiente del compresor y prevenir problemas relacionados con el sobrecalentamiento. Un nivel de refrigerante incorrecto puede provocar un rendimiento deficiente del compresor y daños en los componentes. Es importante verificar y ajustar el nivel de refrigerante según las especificaciones del fabricante.',
        pasos: [
          'Apagar el compresor y desconectar la alimentación eléctrica.',
    ...
    },
    {
      ...
      detallesAdicionales: {
        descripcion:
          'El reemplazo de las juntas de compresor es fundamental para prevenir fugas de aire y garantizar la hermeticidad del sistema. Las juntas desgastadas o dañadas pueden permitir la fuga de aire, lo que reduce la eficiencia del compresor y puede provocar un mal funcionamiento. Es importante inspeccionar regularmente las juntas y reemplazarlas según sea necesario.',
        pasos: [
          'Apagar el compresor y desconectar la alimentación eléctrica.',
    ...
    },
    {
      ...
      detallesAdicionales: {
        descripcion:
          'La revisión del sistema de control del compresor es importante para garantizar un funcionamiento seguro y eficiente. Esto incluye la inspección de los controles de presión, temperatura y flujo, así como la verificación de la calibración y el funcionamiento correcto de los dispositivos de seguridad. Es importante realizar esta revisión de forma regular para detectar y corregir cualquier problema antes de que afecte el rendimiento del compresor.',
        pasos: [
          'Apagar el compresor y desconectar la alimentación eléctrica.',
